...
public class SinisterProjectile extends Projectile{

	public SinisterProjectile(StardustGame game, double t, StardustEntity owner) {
	...
	private double l[]={
			-1,-1,0,-3,0,-3,1,-1,1,-1,3,0,3,0,1,1,1,1,0,3,0,3,-1,1,-1,1,-3,0,-1,-1,-3,0,-2,0,0,-2,0,-2,2,0,2,0,0,2,0,2,-2,0,
	};
	...
	protected void onImpactWith(StardustEntity e) {
		if(e instanceof SinisterEntity){
			active=true;
			return;
		}
		e.setTarget(owner);
