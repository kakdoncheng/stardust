...
public class StarfighterTypeM extends Starcraft{
	
	public int points() {
		return 40;
	}
	
	public StarfighterTypeM(StardustGame game, double x, double y) {
		super(game);
		this.setBoundRadius(8);
		this.setXY(x, y);
	}
	
	private double aF=300;
	...
	private double l[]={
		-2,0,-1,-2,-1,-2,1,-2,1,-2,2,0,2,0,2,-4,2,-4,3,1,3,1,8,2,8,2,8,-8,8,-8,10,0,10,0,10,6,10,6,8,10,8,10,8,4,8,4,3,5,3,5,2,7,2,7,2,5,2,5,0,6,0,6,-2,5,-2,5,-2,7,-2,7,-3,5,-3,5,-8,4,-8,4,-8,10,-8,10,-10,6,-10,6,-10,0,-10,0,-8,-8,-8,-8,-8,2,-8,2,-3,1,-3,1,-2,-4,-2,-4,-2,0,
	};
