...
public class IndicatorDangerRight extends StardustEntity{
	
	public IndicatorDangerRight(StardustGame game, double x, double y) {
		super(game);
		this.setXY(x, y);
	...
	private double l[][]={
			{-18,-9,-20,-10,-20,-10,-20,10,-20,10,-18,9,-18,9,-18,-9},
			{-14,-7,-16,-8,-16,-8,-16,8,-16,8,-14,7,-14,7,-14,-7},
			{0,0,-12,-6,-12,-6,-12,6,-12,6,0,0},
	};
	private double al[]={
			0,0,0
	};
	...
	public void render(Camera c) {
		...
		if(rt%0.5<0.25){
			CharGraphics.drawRedHeaderString("! DANGER !", c.$cx(x-20)-90, c.$cy(y+28), 1f);
		}
		// render arrow
