...
public class Drone extends Starcraft{
	
	public int points() {
		return 25;
	}
	
	public Drone(StardustGame game, double x, double y) {
		super(game);
		setXY(x,y);
		setBoundRadius(8);
		setDirection(0);
	...
	private double[] cy={-2,-2,-3,-2,-1,-3,-1, 2, 4, 2, 1, 0, 1, 2, 4, 3, 3, 3, 4, 2, 1, 0, 1, 2, 4, 2,-1,-3,-1,-2,-3};
